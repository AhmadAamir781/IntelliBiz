          ...
          <Dialog key={index}>
            ...
            <DialogContent className="max-w-4xl p-0 bg-transparent border-none">
              <div className="relative">
                <img
                  src={images[selectedImage !== null ? selectedImage : index]}
                  alt={`${businessName} image ${selectedImage !== null ? selectedImage + 1 : index + 1}`}
                ...
                <div className="absolute bottom-2 left-1/2 -translate-x-1/2 bg-black/50 text-white px-2 py-1 rounded text-sm">
                  {(selectedImage !== null ? selectedImage : index) + 1} / {images.length}
                </div>
              </div>
            </DialogContent>
          </Dialog>
